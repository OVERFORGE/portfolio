...
export default function Footer() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("dakshkaushal@theexecutioners.in");
    setCopied(true);
      ...
      <div className="absolute bottom-6 sm:bottom-10 w-full px-8 sm:px-16 flex flex-col z-20">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-white/40 text-[9px] sm:text-xs font-sans uppercase tracking-[0.2em]">
          ...
          <div className="flex gap-6 sm:gap-10">
            <a href="https://x.com/Dakshkaushaleth" className="hover:text-[--salmon] transition-colors cursor-pointer pointer-events-auto" target="_blank">X(TWITTER)</a>
            <a href="https://www.linkedin.com/in/daksh-kaushal/" className="hover:text-[--salmon] transition-colors cursor-pointer pointer-events-auto" target="_blank">LinkedIn</a>
            <a href="https://github.com/OVERFORGE" className="hover:text-[--salmon] transition-colors cursor-pointer pointer-events-auto" target="_blank">Github</a>
          </div>
        </div>
      </div>
