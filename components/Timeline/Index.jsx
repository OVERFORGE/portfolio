...
export default function Timeline() {
  ...
  const milestones = [
    { year: "2020", title: "Computer Science Degree", desc: "Graduated with honors, mastering algorithms, systems architecture, and raw computation.", side: "left" },
    { year: "2021", title: "First 1M Impressions", desc: "Organically scaled social brands and captured global attention through high-impact content strategies.", side: "right" },
    { year: "2022", title: "Web3 Transition", desc: "Shipped my first robust dApp. Bridged smart contracts with ultra-modern React frameworks.", side: "left" },
    { year: "2023", title: "Founding Teams", desc: "Acted as a core founding member pushing technical boundaries for 5+ emerging blockchain networks.", side: "right" },
    { year: "2024", title: "The Executioners", desc: "Operating as an elite full-stack architect shipping flawless products for worldwide clients.", side: "left" }
  ];
